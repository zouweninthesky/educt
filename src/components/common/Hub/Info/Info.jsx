				...
				<div className="hub-info__wrapper">
					...
					<div className="hub-info__content-wrapper">
				 	  ...
				 	  <dl className="hub-info__quality-list">
					 	  ...
					 	  <dd className="hub-info__description">{chosenScript.description}</dd>
					 	  <dt className="hub-info__quality-name">Теги</dt>
					 	  <dd className="hub-info__tags">{chosenScript.tags.length !== 0 
				 	  ...
				 	  <div className="hub-info__button-wrapper">
					 	  <div className="hub-info__small-button-wrapper">
						 	  <Link to="/player/:id/test" className="hub-info__button hub-info__button--outline button">Тестирование</Link>	
						 	  <button type="button" className="hub-info__stats hub-info__button hub-info__button--outline button">
					 	  ...
					 	  <Link to="/player/:id/show" className="hub-info__button button">Пройти сценарий</Link>
				 	  </div>
			 	  </div>
		 	  </div>
			</section>
