	...
	return (
		<section className="panel">
			...
			<div className="panel__left-side">
				<button className="panel__button" type="button" onClick={() => toggleClose()}>
			...
			<div className="panel__center">
				<button type="button" className="panel__button" onClick={prevSlide} disabled={disablePrev}>
					<svg width="24" height="24">
						<use href={sprite + "#icon-angle-left"}/>
					</svg>
				</button>
				<button type="button" className="panel__button" onClick={nextSlide} disabled={disableNext}>
					<svg width="24" height="24">
