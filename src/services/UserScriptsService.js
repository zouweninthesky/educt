	...
	data = [
		{
			...
			description: 'Тут будет описание для этого сцернария. Пользователь только почитать может, а редактор изменить еще. Надо придумать ограничение по количеству симоволов.',
